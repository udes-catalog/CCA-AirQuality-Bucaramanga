...
proc cancorr data=WORK.ACCE4 out=Work._tempout vname="climatic condition’s" 
		vprefix=V wname="atmospheric pollutant" wprefix=W ncan=1 redundancy vreg b;
